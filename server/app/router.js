...
module.exports = app => {
  ...
  router.post('/api/house/add', controller.house.add);
  router.post('/api/house/mine', controller.house.mine);
  router.post('/api/house/del', controller.house.delete);
  ...
  router.post('/api/gift/list', controller.gift.list);
  router.post('/api/gift/change', controller.gift.change);
};
